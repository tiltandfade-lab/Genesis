...
- `KENNEY-GRAPHICS-REPAIR-OPERATION.md` — SPECCED corrective operation for the Kenney walk-to-graphics pipeline: transform/UV/bounds repair, safe fallback rendering, sidecar calibration, six-degree-of-freedom sockets, a manual socket workbench, approval-driven runtime admission, footprint-aware walk-native realization, and a capture/playtest proving gate. (2026-07-16)
