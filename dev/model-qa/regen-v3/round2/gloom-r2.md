# ROUND 2 — gloom (the VHS-horror expansion; codex never reached it)

Style reference: dev/model-qa/regen-v3/style-refs/gloom-style-ref.png
...
## Sheet 6: `gloom-horror-npcs-v3-06.png` — 12 sprites, 3 rows x 4 columns
...
2. skeptical small-town sheriff, flashlight and revolver crossed
3. occult librarian clutching a chained grimoire and a card catalog drawer
4. backwoods trapper who warned them all, shotgun broken over one arm
5. seance medium in mourning lace, candle guttering in her hand
6. paranormal investigator with a reel-to-reel recorder slung and a microphone out
7. priest with shaken faith, crucifix held slightly too tight
8. morgue attendant in a rubber apron with a clipboard
9. video-store clerk kid who knows all the rules, pointing them out on his fingers
10. grave-digger leaning on a shovel, watching the treeline
11. town drunk who saw it first, gesturing wide-eyed
12. witch of the hollow, hunched, offering a summons for a price
```

## Sheet 7: `gloom-horror-monsters-v3-07.png` — 16 sprites, 4 rows x 4 columns
...
2. murderous little cobbler-fae in a green coat and buckled hat, counting gold, straight razor out
3. hook-handed mirror legend in a fur-lined coat, wreathed in bees
4. drowned boy grown huge in a hockey mask, machete dragging
5. dream-stalker in a striped sweater and fedora, razor glove flexing
6. silent shape in coveralls and a pale blank mask, kitchen knife at his side
7. pin-studded pale ascetic in black leather robes, holding a puzzle box
8. possessed ginger doll in overalls with a kitchen knife
9. white-eyed cackling deadite corpse, wrong joints
10. sewer clown with a red balloon and too many teeth
11. corn-cult child preacher with a sickle and a congregation stare
12. scarecrow slasher pulled loose from its frame, baling hooks for hands
13. teen vampire gang leader, half-shifted, leather jacket and wild grin
14. wolfman mid-transformation, shirt tearing, jaw pushing forward
15. fly-headed scientist hybrid in a ruined lab coat
16. re-animated corpse jerking upright, glowing green serum syringe in its neck
```

## Sheet 8: `gloom-horror-large-v3-08.png` — 6 sprites, 2 rows x 3 columns
...
Subjects, one per cell, left to right then top to bottom:
1. graboid burrower erupting from the earth, jaw petals wide
2. amorphous crimson blob mid-engulf, half a bicycle disappearing into it
3. possessed black muscle car with a grinning grille and one headlight winking
4. spider-legged head-splice horror, a human face scuttling on crab legs
5. swarm-ball of small toothy gremlin-critters rolling as one mound
6. swamp shambler trailing weeds, one arm a root mass
```
