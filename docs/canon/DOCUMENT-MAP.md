...
| Site 2 Camp/Service research packet (2026-07-27 campaign) | `Reference/Camp-Service-Study-0727/` | breadth sweep + measured references + FFT cohort comparison (read in place per the FFT boundary) + license ledger + synthesis; cross-cultural permanence-ladder evidence, proposed status-gate line PENDING CODEX ADVERSARIAL REVIEW |
| Site 3 Dormant/Abandoned research packet (2026-07-27 campaign) | `Reference/Dormant-Abandoned-Study-0727/` | breadth sweep + 12-image ledger + FFT cohort + engine-content audit + synthesis; non-European and decay-rate gaps keep research PARTIAL; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 4 Monastery/Commune research packet (2026-07-27 campaign) | `Reference/Monastery-Study-0727/` | breadth sweep + measured references + FFT cohort comparison + license ledger + synthesis; widens cultural base to eight monastic/communal traditions; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 5 Mine/Workshop research packet (2026-07-27 campaign) | `Reference/Mine-Workshop-Study-0727/` | breadth sweep + measured references + FFT cohort comparison + license ledger + synthesis; closes the direct tactical-map gap; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 6 Prison/Custody research packet (2026-07-27 campaign) | `Reference/Prison-Custody-Study-0727/` | breadth sweep + measured references + FFT cohort comparison + second doctrine pair (`DOCTRINE-PAIR-TWO.md`) + license ledger + synthesis; declared gaps keep research PARTIAL; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 8 Layered Control research packet (2026-07-27 campaign) | `Reference/Layered-Control-Study-0727/` | first depth-law pass: breadth sweep + FFT cohort + engine audit + license ledger + synthesis; research PARTIAL; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 9 Contested Fortress research packet (2026-07-27 campaign) | `Reference/Contested-Fortress-Study-0727/` | breadth sweep + image study + FFT cohort + roller audit + license ledger + synthesis; interior-imagery gap keeps research PARTIAL; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 10 Urban Institution research packet (2026-07-27 campaign) | `Reference/Urban-Institution-Study-0727/` | breadth sweep + measured references + FFT cohort comparison + license ledger + synthesis; gap-closure addendum folded into the Site 10 spec; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 11 Mixed Scale research packet (2026-07-27 campaign) | `Reference/Mixed-Scale-Study-0727/` | first depth-law pass: breadth sweep + image reference + FFT cohort + engine evidence + synthesis; research PARTIAL; proposed, PENDING CODEX ADVERSARIAL REVIEW |
| Site 12 Anomalous/Living/Mobile research packet (2026-07-27 campaign) | `Reference/Anomalous-Living-Mobile-Study-0727/` | first depth-law pass: breadth sweep + FFT cohort + engine evidence + `substrate-demand-measure.mjs` + license ledger + synthesis; research PARTIAL; proposed, PENDING CODEX ADVERSARIAL REVIEW |
