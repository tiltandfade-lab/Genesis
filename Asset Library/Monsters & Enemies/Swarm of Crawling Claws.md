...
- **STR:** 14 (+2) | **DEX:** 14 (+2) | **CON:** 11 (+0) | **INT:** 5 (-3) | **WIS:** 10 (+0) | **CHA:** 4 (-3)
...
- **Swarm of Grasping Hands.** Melee Attack Roll: +4, reach 5 ft. Hit: 20 (4d8 + 2) Necrotic damage, or 11 (2d8 + 2) Necrotic damage if the swarm is Bloodied. If the target is a Medium or smaller creature, it has the Prone condition. Cultists
