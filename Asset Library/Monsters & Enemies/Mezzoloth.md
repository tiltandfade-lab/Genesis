...
- **Speed:** 40 ft.
- **STR:** 18 (+4) | **DEX:** 11 (+0) | **CON:** 16 (+3) | **INT:** 7 (−2) | **WIS:** 14 (+2) | **CHA:** 10 (+0)
- **Skills:** Perception +5
...
- **Fiendish Restoration.** If the mezzoloth dies outside Gehenna, its body instantly dissolves into ichor, and it gains a new body instantly, reviving with all its Hit Points somewhere in Gehenna.
...
- **Claws.** *Melee Attack Roll:* +7, reach 5 ft. Hit: 9 (2d4 + 4) Slashing damage. If the target is a Large (14) creature, it also has the Restrained condition until freed from the grapple ends.
...
- **Spellcasting.** The mezzoloth casts one of the following spells, requiring no Material components and using Wisdom as the spellcasting ability. *At Will:* Cloudkill, Darkness, Dispel Magic. *1/Day Each:* Cloudkill, Darkness, Dispel Magic.
