...
**Status:** O2.1-O2.11 answered in sections 10.1-10.11; G2.1 active; G2.2 queued; P2.12-P2.20 newly formulated.
...
- **G2.1 - SceneFactGraph promotion (ACTIVE):** finish the full fact-promotion, callback, semantic-invention,
  compilation, precedent, and certification follow-up tree.
- **G2.2 - cooperative CrisisChain (NEXT):** decide how multi-actor crisis play consumes roster roles, flows,
  props, conditions, clocks, and contributions without duplicating the site simulation or becoming one abstract
  progress bar.
