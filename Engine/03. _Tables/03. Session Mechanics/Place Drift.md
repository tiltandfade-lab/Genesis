...
|---|---|---|---|
| 1 | Grounded | **Prices crept.** ★ | The ferryman's rate is up two coppers and he blames the season; the inn repainted its door; someone you knew by face has moved on. |
| 2 | Grounded | **The shop you remembered has a new sign.** | Same building, different trade — the old owner sold up or moved on, and the new one doesn't know your name yet. |
| 3 | Grounded | **A familiar face is missing from their usual post.** | The stall, the doorway, the bench — empty, or occupied by someone else who shrugs when you ask after them. |
| 4 | Grounded | **The road's been resurfaced, badly.** | Fresh cobbles in one stretch, uneven and already loosening, laid by whoever won the cheapest contract. |
| 5 | Grounded | **A season's weather has left its mark.** | Storm damage patched, a scorched patch of field regrown, a roof re-thatched — the place has weathered something since you left. |
| 6 | Grounded | **The local gossip has moved on to new subjects.** | Whatever was the talk of the town when you left is old news now; there's a fresher scandal, and no one mentions the last one. |
| 7 | Grounded | **A new fence has gone up around a familiar plot.** | Someone's claimed or fenced land that used to be common ground, with a notice too small to read from the road. |
| 8 | Grounded | **The tavern's got a new house specialty.** | The old regular dish is off the board, replaced by something the new cook favors; the regulars have opinions, loudly. |
| 9 | Grounded | **A minor official has been replaced.** | New face behind the counter, new handwriting on the forms, and a slightly different set of rules being enforced. |
| 10 | Grounded | **The well-worn path has shifted a few yards.** | Traffic's worn a new route around an obstacle that wasn't there before — a fallen branch, a new stall, a puddle that won't drain. |
| 11 | Grounded | **Someone's added a room onto their house.** | A visible new addition, fresh timber against old, funded by some stroke of luck or labor since your last visit. |
| 12 | Grounded | **The local shrine has new offerings.** | Different tokens, different prayers scratched into the wood — the congregation's needs have shifted since you were last here. |
| 13 | Grounded | **A rumor about you has taken on a life of its own.** | Your name's attached to a story that's grown in the telling, and it's only loosely related to what actually happened. |
| 14 | Grounded | **The market's rearranged its stalls.** | Familiar vendors are in unfamiliar spots, and it takes a minute to relocate the one selling what you're after. |
| 15 | Grounded | **A dog you remember has had puppies, or died.** | Small, ordinary evidence that time kept moving here whether or not you were around to see it. |
| 16 | Grounded | **The notice board has been repainted and refilled.** | Old bounties and bulletins are gone, replaced with fresher business — a different set of problems now needs solving. |
| 17 | Grounded | **A local feud has quietly ended.** | Two households that wouldn't speak now nod in passing; something resolved it, and nobody's eager to explain what. |
| 18 | Grounded | **The blacksmith's changed his prices.** | Material costs or demand have shifted the going rate, and he's not shy about explaining exactly why if you ask. |
| 19 | Grounded | **A festival you don't remember has become an annual fixture.** | Bunting half up already for next time, and locals assume you know the tradition as well as they do. |
| 20 | Grounded | **The inn's changed hands.** | Same building, new management, and the house rules — and the welcome — are noticeably different. |
| 21 | Grounded | **A road sign's been replaced or repositioned.** | The old one was wrong, or worn out, or the road itself shifted slightly — small, practical, easy to miss. |
| 22 | Grounded | **The local children have grown enough to not recognize you.** | A visible generational tick of the clock — faces that were small are taller, and don't know who you are. |
| 23 | Grounded | **A shop's window display has changed with the season.** | Small, cosmetic, but a genuine marker that life here kept its own rhythm without waiting for your return. |
| 24 | Grounded | **The town crier's rounds have a new route.** | A schedule change nobody thought to announce beyond the locals, leaving out-of-towners perpetually a beat behind the news. |
| 25 | Grounded | **A minor bridge or crossing has been repaired.** | New planks over old stone, funded by someone, for reasons that took less time to arrange than you'd think. |
| 26 | Grounded | **The seasonal produce at market has shifted.** | A crop failed or thrived since you left, and the stalls reflect it in prices and abundance both. |
| 27 | Grounded | **A local craftsman has taken on an apprentice.** | New, younger hands at the bench, learning the trade, evidence that the work here plans to outlast its current master. |
| 28 | Grounded | **The town's watch uniforms have new trim or badges.** | A small heraldic update, funded and ordered by whoever's currently paying their wages. |
| 29 | Grounded | **A previously vacant building now has tenants.** | Curtains in windows that used to be dark, smoke from a chimney that used to be cold — someone's moved in. |
| 30 | Grounded | **The local well or pump has a new mechanism.** | An upgrade, however modest, funded by pooled coin or a patron with an interest in easier water. |
| 31 | Grounded | **A familiar rumor mill has a new prime source.** | The old town gossip has retired from the role, formally or otherwise, and someone else has taken up the mantle. |
| 32 | Grounded | **The graveyard has a few new markers.** | Names you might or might not recognize, and the specific quiet grief of a community that's kept living without you. |
| 33 | Grounded | **A local trade has adjusted its guild dues.** | New rates posted, met with the usual grumbling, a small economic ripple from decisions made while you were elsewhere. |
| 34 | Grounded | **The town's collection of stray animals has changed composition.** | Different cats, different dogs holding down the same corners — the population turns over even when the corners don't. |
| 35 | Grounded | **A recently married couple has settled into town life.** | New names on a lease, a household forming, the ordinary business of people building something while you were away. |
| 36 | Grounded | **The seasonal decorations are up early or late.** | A small mismatch with your internal calendar, a reminder that the town's rhythms don't pause for your absence. |
| 37 | Grounded | **A local business has expanded into the next stall.** | A wall knocked through, a bigger sign, evidence of a modest success achieved without your having noticed it happen. |
...
| 45 | Grounded | **A minor building has been repainted a new color.** | A cosmetic choice, funded by someone's opinion and coin, changing the street's silhouette by one shade. |
| 46 | Grounded | **The local well-water has developed a mild new mineral taste.** | Nothing dangerous, just noticeably different — the water table shifting in some small, explicable way. |
| 47 | Grounded | **A traveling merchant now visits on a regular schedule.** | A new fixture in the town's economic rhythm, arriving and departing on a cadence the locals have already adjusted to. |
| 48 | Grounded | **The town gate's night-watch roster has new names on it.** | Younger faces taking the late shift, the old hands moved to easier hours or retired from the duty entirely. |
| 49 | Grounded | **A once-empty lot now has a modest garden.** | Someone's claimed the unused ground, planted something, and it's clearly been tended with real care. |
...
| 57 | Grounded | **A minor road has been renamed by informal consensus.** | Nobody voted on it, but everyone's calling it something new now, for a reason half the town has already forgotten. |
