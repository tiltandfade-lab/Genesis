...
![Site 5 proposed family](diagrams/mine-workshop-family-board.svg)
...
![Accepted first-build section](diagrams/mine-first-build-section.svg)
...
![First-build strategic plan](diagrams/mine-first-build-plan.svg)
