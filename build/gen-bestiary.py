...
def main():
    ...
    for fn in files:
        ...
        for sb in blocks:
            sb.update(file_meta)
            sb["src"] = fn                            # provenance: the Asset Library filename this
                                                        # block was parsed from (bestiary dashboard edit-target bundle)
            if tables:
    ...
    header = ("/* GENESIS DATA (generated) — data/bestiary.js\n"
              ...
              "   src = the Asset Library filename the block was parsed from (provenance for the\n"
              "   bestiary dashboard).\n"
