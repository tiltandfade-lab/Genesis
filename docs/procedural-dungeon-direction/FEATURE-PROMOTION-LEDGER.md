...
| Bounded town continuity | A compact canonical district graph owns stable venue nodes, thresholds, short edges, access, and shared cast/object/condition truth; real-roll reusable urban grids mount only active venues; short Urban Walk/direct thresholds preserve time and due updates; the same venue legally promotes to BattleMat and retains material aftermath; active/site/cold receipts advance bounded offscreen clocks/stocks/relations/events without continuous citizen simulation | C2M after connected core | C2M plus remaining F10.9h gates | Scoped contiguous town slices, richer ambient citizens, enabled C4D companion roaming, cross-venue events, and broader venue grammars; no entitlement to simulate every street/building/resident or generate bespoke venue imagery | The retained district feels like disconnected menus, cannot remount meaningful changes, or cannot host accepted same-scene social/companion consequences | MAPPED IN PART; F10.9h.1-h.5 accepted at 11.85, h.6-h.10 live at 11.86 |
...
- P10.9 F10.9a accepted the transactional SceneLineage handoff and added C2D as the first retained continuity proof;
  ...
  enrichment; h.1-h.5 now bind the district graph, real-roll venue grids, same-venue battle/aftermath, bounded
  offscreen receipts, and short Urban Walk transitions to C2M, while h.6-h.10 are live. Generated P10.9 follow-ups still own the town, CrisisChain, and broader recovery/
