...
`THEATER_ENV_PALETTE` for FFT-legible contrast), and fold in REALM-RENDER-STYLE grading. Plain
...
*59 systems indexed. When you add or materially change a system, add/update its entry here and
