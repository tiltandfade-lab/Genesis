...
The rank-and-file raiders comprising the bulk of the war band. They fight with crude, scavenged armor and weapons, relying on numbers and sheer ferocity.
...
- **Rend.** _Melee Attack Roll:_ +4 to hit, reach 5 ft., one target. _Hit:_ 5 (1d6 + 2) piercing damage.
- **Bone Bow.** _Ranged Attack Roll:_ +3 to hit, range 150/600 ft., one target. _Hit:_ 6 (1d10 + 1) piercing damage.
...
The alpha of the pack, earning their place through ruthless intimidation. They claim the best scavenged armor, adorn themselves in grotesque trophies, and wield heavy weapons like glaives to dictate the battlefield.
...
- **Hit Points:** 49 (9d8 + 9)
- **Speed:** 30 ft.
- **STR:** 16 (+3) | **DEX:** 14 (+2) | **CON:** 13 (+1) | **INT:** 8 (-1) | **WIS:** 11 (+0) | **CHA:** 9 (-1)
- **Senses:** Darkvision 60 ft., passive Perception 10
- **Languages:** Gnoll
...
- **Multiattack.** The gnoll makes two Bone Whip or Bone Javelin attacks in any combination, and it uses Incite Rampage if available.
- **Bone Whip.** _Melee Attack Roll:_ +5 to hit, reach 10 ft., one target. _Hit:_ 8 (2d4 + 3) slashing damage.
- **Bone Javelin.** _Ranged Attack Roll:_ +5 to hit, range 30/120 ft., one target. _Hit:_ 7 (1d8 + 3) piercing damage.
...
- **Speed:** 30 ft.
- **STR:** 17 (+3) | **DEX:** 15 (+2) | **CON:** 15 (+2) | **INT:** 10 (+0) | **WIS:** 11 (+0) | **CHA:** 13 (+1)
- **Senses:** Darkvision 60 ft., passive Perception 10
...
- **Bite.** _Melee Attack Roll:_ +5 to hit, reach 5 ft., one target. _Hit:_ 6 (1d6 + 3) piercing damage, and the target has the Poisoned condition until the start of the gnoll's next turn.
- **Bone Flail.** _Melee Attack Roll:_ +5 to hit, reach 10 ft., one target. _Hit:_ 7 (1d8 + 3) piercing damage.
...
- **Speed:** 30 ft.
- **STR:** 16 (+3) | **DEX:** 12 (+1) | **CON:** 17 (+3) | **INT:** 14 (+2) | **WIS:** 15 (+2) | **CHA:** 17 (+3)
- **Skills:** Perception +5
...
### d10 The War Band's Motive & Tone (Tone Variance)

Gnoll packs can range from apocalyptic horrors to darkly comedic villains, making them highly versatile for different campaigns.

|d10|The War Band's Behavior|Campaign Tone & Execution|
|:--|:--|:--|
|**1**|**The Culinary Snobs**|**Humorous:** The pack has conquered a local tavern. Instead of slaughtering the patrons, they are forcing the terrified chef to teach them how to make pastries and fine sauces, rejecting "raw meat" as uncultured.|
|**2**|**The Easily Distracted**|**Lighthearted:** The gnolls are incredibly fierce but have the attention span of actual dogs. A clever party can entirely bypass their blockade by throwing a shiny object, a bag of bones, or an illusion of a running cat.|
|**3**|**The Cowardly Bullies**|**Pulp / Action:** The gnolls act incredibly tough when they outnumber a foe 10-to-1, but the moment the Pack Lord is killed or the PCs cast a loud, fiery spell, the rest of the pack scatters in comical, yipping terror.|
|**4**|**The Tax Collectors**|**Intrigue:** A surprisingly intelligent pack doesn't kill travelers. They run a heavily armed tollbooth on a major trade road. They demand payment exclusively in livestock, raw iron, or shiny baubles to let merchants pass.|
...
### d10 The Butcher's Wake (Investigation & Clues)

Gnolls are notoriously messy, making them easy to track but dangerous to follow.

|d10|Discovery|Investigative Hook & Meaning|
|:--|:--|:--|
