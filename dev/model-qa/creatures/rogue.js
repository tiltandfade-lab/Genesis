/* dev/model-qa/creatures/rogue.js — MODULARITY PROOF: a class assembled from the shared parts kit.
   Almost nothing here is rogue-specific geometry code. The head, hood, base, arms, and the DAGGER
   are all shared modules from parts.js — the dagger is instantiated TWICE with different grips
   (equipment-as-module). Only the leather torso + legs (the "body" slot) are authored inline.
   Twin daggers authored FIRST; both fists derive from their grips. */
