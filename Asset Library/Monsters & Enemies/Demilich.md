...
- **STR:** 1 (−5) | **DEX:** 20 (+5) | **CON:** 10 (+0) | **INT:** 20 (+5) | **WIS:** 17 (+3) | **CHA:** 20 (+5)
...
- **Languages:** None
- **Challenge:** 18 (20,000 XP, or 22,000 XP in lair) | **Proficiency Bonus:** +6

**Traits**

- **Legendary Resistance (3/Day, or 4/Day in Lair).** If the demilich fails a saving throw, it can choose to succeed instead.
- **Undead Restoration.** If the demilich is destroyed, it re-forms and regains all its Hit Points in 1d10 days unless a Wish spell is cast on its remains.
...
- **Energy Drain.** Constitution Saving Throw: DC 19, one creature the demilich can see within 120 feet. Failure: The target has the Blinded condition until the start of the demilich's next turn. Failure or Success: The demilich can't take this action again until the start of its next turn.
- **Grave-Dust Flight.** The demilich flies up to its Fly Speed without provoking Opportunity Attacks. Each creature within 5 feet of the demilich as it moves is targeted once by the Petrified condition. Failure or Success: The demilich can't take this action again until the start of its next turn.
- **Necrosis.** The demilich makes one Necrotic Burst attack.
- **Sickening Ray.** The demilich uses Spellcasting to cast Ray of Sickness.
