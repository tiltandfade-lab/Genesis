...
_Medium Celestial or Fiend (Titan), Neutral_

- **Armor Class:** 13
- **Initiative:** +2 (12)
- **Hit Points:** 22 (5d8)
- **Speed:** 5 ft., Fly 30 ft. (hover)
- **STR:** 1 (−5) | **DEX:** 14 (+2) | **CON:** 10 (+0) | **INT:** 15 (+2) | **WIS:** 16 (+3) | **CHA:** 16 (+3)
...
- **Spellcasting.** The empyrean casts one of the following spells, requiring no Material components and using Wisdom as the spellcasting ability: 1/Day Each: Bless, Lesser Restoration (as an action).

**Bonus Actions**

- **Healing Word (1/Day).** The empyrean casts Healing Word, using the same spellcasting ability as Spellcasting.
...
_Huge Celestial or Fiend (Titan), Neutral_

- **Armor Class:** 22
- **Initiative:** +19 (29)
- **Hit Points:** 346 (21d12 + 210)
- **Speed:** 50 ft., Fly 50 ft. (hover), Swim 50 ft.
- **STR:** 30 (+10) | **DEX:** 17 (+3) | **CON:** 30 (+10) | **INT:** 21 (+5) | **WIS:** 22 (+6) | **CHA:** 27 (+8)
- **Skills:** Insight +13, Perception +13
- **Resistances:** Bludgeoning, Piercing, Slashing
- **Immunities:** Prone
- **Senses:** Truesight 120 ft., passive Perception 23
- **Languages:** All
- **Challenge:** 23 (XP 50,000) | **Proficiency Bonus:** +7
...
- **Sacred Weapon.** Melee Attack Roll: +17, reach 10 ft. Hit: 7 (1d8 + 10) Force damage plus 10 (3d6) Radiant damage. The target can choose not to be Stunned, in which case it takes an extra 21 (6d6) Force damage that bypasses Resistance or Immunity.
...
- **Shockwave of Glory.** Constitution Saving Throw: DC 23, each creature in a 30-foot Emanation originating from the empyrean. Failure: 27 (6d8) Force damage, and the target has the Prone condition. Failure or Success: The empyrean can't take this action again until the start of its next turn.
