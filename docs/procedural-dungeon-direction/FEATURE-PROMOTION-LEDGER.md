...
| Shared procedural BattleMap/TownTray composition | One retained real-roll room exposes stable composition/surface ids and diagnostics, then C1H proves coherent elevation masses, typed visible connectors, a primary spine, licensed landmark or structural dominant, deployment/objective reservations, shaped negative space, dressed parity, and honest four-yaw tactics; TownTray may not fork geometry authority | C1A diagnostic seam; C1H composition gate after connected C1A-D | C1H plus C2D continuity and C2M same-venue TownTray reuse | Twelve contrasting structural fixtures accumulated one at a time; richer venue/wilderness recipes; optional stacked surfaces; offline automatic unwrap only for reusable complex assets that trigger it | One-room clay output remains noisy/unintentional, dressed art changes tactics, four-yaw captures hide critical relations, town needs a second generator, or a reusable complex asset cannot be surfaced by procedural/authored UVs | MAPPED; high-priority direction accepted at Wave 10 section 11.90, implementation unaudited |
| Architectural trim-sheet surfacing | One stable manifest-driven horizontal layout and one architecture-material family route plain fallback, base-course, cornice, cap/nosing, and curb/retaining roles onto real C1H procedural runs through deterministic independent-strip packing, fixed physical scale, repeat-boundary segmentation, corner/endpoint/occlusion ownership, geometry-only fallback, four-yaw proof, and unchanged tactics; realm grade is secondary to canonical material | C1I after C1H | C1I plus C2M reuse of the same layout/run/material/fallback authority | Broader architecture-material variants; physical profile sweeps; roof/beam/frame/bridge/town roles; aligned normal/ORM channels; caps/corners/junctions; measured shader/batching optimization | C1I is mechanically unchanged but visually false, motifs stretch/pinch/bleed, material rolls are contradicted, TownTray needs another atlas schema, or P10.10 shows segmentation/batching cost warrants shader promotion | MAPPED; T10.1-T10.5 Option B accepted at Wave 10 section 11.92, implementation unaudited |
| Mode continuity | Typed idempotent SceneLineage handoff preserves lineage, ownership, cast/roles, objects/custody, damage/traces/hazards, viewpoint knowledge, obligations, consequence cursor, and recovery across exploration -> battle -> aftermath; spatial facts retain an honest exact/anchored/zone-or-route/unresolved tier and provenance-bearing placement/compaction receipt; pre-alpha staging is an orientation-preserving crossfade/reframe plus one short fiction-first DM-seat/fallback bridge and no mechanical summary; broader required adapter traces remain owned by open P10.9 | C2D | C2D plus remaining P10.9-named MVP traces | C2F restrained landmark/placement continuity beat; seamless morphs, richer camera memory, simultaneous split-view presentation, broad adapter polish | Correct handoffs remain disorienting, or dungeon/investigation/CrisisChain/aftermath cases exceed the shared bundle | MAPPED IN PART; F10.9a-h accepted/closed by family, F10.9i-m live at 11.95 |
...
- P10.9 F10.9a accepted the transactional SceneLineage handoff and added C2D as the first retained continuity proof;
  ...
  leave/return fixture to C2M. F10.9i-m now own dungeon movement, investigation, CrisisChain projection/parallel
  pressure, and aftermath compaction; P10.9 remains open.
