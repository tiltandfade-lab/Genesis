...
_Medium Swarm of Tiny Monstrosities, Unaligned_

- **Armor Class:** 14
- **Initiative:** +3 (13)
- **Hit Points:** 36 (8d8)
- **Speed:** 10 ft., Fly 40 ft.
- **STR:** 4 (-3) | **DEX:** 16 (+3) | **CON:** 11 (+0) | **INT:** 2 (-4) | **WIS:** 5 (-3) | **CHA:** 6 (-2)
...
- **Swarm of Proboscises.** Melee Attack Roll: +5, reach 5 ft. Hit: 14 (2d10 + 3) Piercing damage, or 8 (1d10 + 3) Piercing damage if the swarm is Bloodied. If the target is a Medium or smaller creature, the target has the Grappled condition (escape DC 13). Until the grapple ends, the target takes 7 (2d6) Necrotic damage at the end of each of its turns.
