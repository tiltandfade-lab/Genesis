...
Status: **GAP-CLOSE PASS RETURNED — closes the measured-breadth gap and drafts a second
doctrine pair**
Date: 2026-07-27

This packet is a targeted gap-close of `docs/GOLDEN-SITES-CATALOG.md`'s declared Site 6 status
("global measured breadth, later doctrines, implementation reconciliation, and clay proof remain
open") per the 2026-07-27 campaign brief: "Close the measured-breadth gap (cross-cultural
...
- `BREADTH-SWEEP.md` — "what else could this site be": demand evidence, one new form-family
  candidate (folded into the doctrine pair rather than a new site), five candidates confirmed
  already covered by existing boundary law, and two edge cases flagged but not resolved.
- `MEASURED-REFERENCES.md` — real, dated, sourced cross-cultural custody evidence: Qing-dynasty
  China (a measured yamen compound), Edo-period Japan (a measured jail with capacity/staffing/
  classification and a reachable architectural plan), a matched pair of custody-without-
  architecture traditions (English frankpledge, Japanese gonin-gumi), a partial Mesoamerican
...
- `docs/BUILDING-PROGRAM-TABLE-FAMILIES.md` — the `BF-CUSTODY` family this pass checks (and
  finds no reconciliation debt against) in `synthesis.md` §5.
- `Reference/Prison-Custody-Study/` — the original 2026-07-25 packet (SOURCE-LEDGER, synthesis,
  culture-doctrine-cards). This new packet is additive to it, not a replacement, and does not
  edit any of its files.
- `docs/intel-sites/SITE-6-SPAWNABLE.md` — the spawnable-content inventory this pass also
  produces, feeding the spawn-audit lane.

## Honest current result

The measured-breadth gap is substantially, not fully, closed: two independent non-Anglo-American
...
plan's labels are untranslated; the teilpiloyan has no image; hostage/surety, quarantine, and
religious-penance custody remain research-needed; the suspended living-ironwood fixture still has
no honest historical analogue; and nothing here is clay-proved or founder-ruled.
