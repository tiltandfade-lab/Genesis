...
| Current Golden engine implementation cut | `docs/GOLDEN-SITE-WAVE-1-OBSERVATORY-BRIEF.md` | deterministic demand census, read-only adapters, dispositions, unresolved/asset ledgers, Gate W1 |
...
| Typed building family/table architecture | `docs/BUILDING-PROGRAM-TABLE-FAMILIES.md` | founder-ruled seven-family core including dedicated Prison/Custody; proposed eighth Market/Exchange addendum; per-program operation/current-scene/Spice layers; d300 reduced to untyped/adaptive-reuse role |
| Typed building family taste samples | `Reference/Building-Family-Table-Samples/` | seven founder-ruled d6/d4 family tranches plus proposed Market/Exchange eighth tranche; explicit arrangement/chassis eligibility, all fourteen live programs plus custody and two proposed market programs, three upper-program composition cards, and 32 deterministic founder-review receipts |
...
| Site 3 Dormant/Abandoned working spec | `docs/SITE-3-DORMANT-CONCEPT.md` | cross-host Dormant transform; stable-occupancy boundary, conditional aperture-first profile, ordinary Funerary/Mortuary host |
...
| Site 8 Layered Control working spec | `docs/SITE-8-LAYERED-CONTROL-SPEC.md` | cross-host claimant/access/schedule transform; adversarially narrowed visual profiles and evidence claims |
| Site 9 Contested Fortress working spec | `docs/SITE-9-CONTESTED-FORTRESS-SPEC.md` | Defense/Fortification + Layered Control + persistent multi-window stress proof |
...
| Site 11 Mixed Scale working spec | `docs/SITE-11-MIXED-SCALE-SPEC.md` | shared ScaleContract stress proof; consequential affordance test; shared GranularMass proposal |
| Site 12 Anomalous/Living/Mobile working spec | `docs/SITE-12-ANOMALOUS-LIVING-MOBILE-SPEC.md` | shared SubstratePlan and terminal substrate-transformation stress proof; orthogonal axes |
...
| Site 2 Camp/Service research packet (2026-07-27 campaign) | `Reference/Camp-Service-Study-0727/` | breadth/measurement/FFT evidence; 2026-07-28 review keys guest-family exit to persistent semantic facts rather than one size/duration threshold |
| Site 3 Dormant/Abandoned research packet (2026-07-27 campaign) | `Reference/Dormant-Abandoned-Study-0727/` | adversarially redlined: stable occupancy legal, aperture-first conditional, Funerary/Mortuary ordinary host; research PARTIAL |
| Site 4 Monastery/Commune research packet (2026-07-27 campaign) | `Reference/Monastery-Study-0727/` | cultural/measured breadth supports multiple communal chassis; founder build order remains open |
| Site 5 Mine/Workshop research packet (2026-07-27 campaign) | `Reference/Mine-Workshop-Study-0727/` | extraction-linked workshop boundary accepted; adversarial review retains RESEARCHED PARTIAL |
| Site 6 Prison/Custody research packet (2026-07-27 campaign) | `Reference/Prison-Custody-Study-0727/` | Yamen candidate retained; Ward-and-Surety external disposition provider; care/asylum boundary separated; research PARTIAL |
| Site 8 Layered Control research packet (2026-07-27 campaign) | `Reference/Layered-Control-Study-0727/` | claimant ingredients measured; same-host activation unmeasured; visual laws narrowed to profiles; research PARTIAL |
| Site 9 Contested Fortress research packet (2026-07-27 campaign) | `Reference/Contested-Fortress-Study-0727/` | host-demand vs. activation corrected; 14 broad setting candidates, two direct; interior-imagery gap keeps research PARTIAL |
| Site 10 Urban Institution research packet (2026-07-27 campaign) | `Reference/Urban-Institution-Study-0727/` | construction/FFT evidence; proposes eighth Market/Exchange building family |
| Site 11 Mixed Scale research packet (2026-07-27 campaign) | `Reference/Mixed-Scale-Study-0727/` | broad object-supply tally distinguished from activation; consequential ScaleContract; research PARTIAL |
| Site 12 Anomalous/Living/Mobile research packet (2026-07-27 campaign) | `Reference/Anomalous-Living-Mobile-Study-0727/` | broad pressure-tag tally distinguished from materialization demand; orthogonal SubstratePlan axes; research PARTIAL |
...
- docs/BUILDING-PROGRAM-TABLE-FAMILIES.md — accepted-supporting — system-spec/ACCEPTED-DIRECTION-seven-family-core-plus-proposed-eighth-sampler-returned-live-implementation-deferred(2026-07-28) — seven founder-ruled typed chassis families including dedicated Prison/Custody; proposed Market/Exchange family has returned taste rolls and awaits founder disposition; program layers, realm/Spice ownership, d300 reduced-role ruling, and Manor/Apothecary first authoring pair
...
- docs/GOLDEN-SITE-WAVE-1-OBSERVATORY-BRIEF.md — current-build — implementation-brief/ACTIVE-W1(2026-07-29) — deterministic audit harness, read-only adapters, demand/disposition ledgers, corpus and Gate W1
...
- docs/SITE-3-DORMANT-CONCEPT.md — accepted-supporting — working-site-spec/RESEARCH-BRIEF-PARTIAL-FOUNDER-OPEN-CLAY-OPEN(2026-07-28) — cross-host Dormant transform; stable occupants legal until host-circuit restoration/replacement; conditional aperture-first profile
...
- docs/SITE-8-LAYERED-CONTROL-SPEC.md — accepted-supporting — working-site-spec/RESEARCH-FOUNDER-BRIEF-PARTIAL-CLAY-OPEN(2026-07-28) — cross-host claimant/access/schedule transform; actor-relative route deltas; conditional grain/envelope/boundary profiles
- docs/SITE-9-CONTESTED-FORTRESS-SPEC.md — accepted-supporting — working-site-spec/RESEARCH-BRIEF-PARTIAL-FOUNDER-OPEN-CLAY-OPEN(2026-07-28) — Defense/Fortification + LayeredControl + MaterializationWindow stress proof; no Site-only fortress generator
...
- docs/SITE-11-MIXED-SCALE-SPEC.md — accepted-supporting — working-site-spec/RESEARCH-BRIEF-PARTIAL-FOUNDER-OPEN-CLAY-OPEN(2026-07-28) — consequential `ScaleContract` stress proof; shared `GranularMass`; activation unmeasured
- docs/SITE-12-ANOMALOUS-LIVING-MOBILE-SPEC.md — accepted-supporting — working-site-spec/RESEARCH-BRIEF-PARTIAL-FOUNDER-OPEN-CLAY-OPEN(2026-07-28) — orthogonal `SubstratePlan` plus terminal transformation; conditional tenure/clock/path/perimeter; activation unmeasured
