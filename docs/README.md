...
- `GOLDEN-SITES-CATALOG.md` — golden-site structure/material kit catalog and the Guard Post brief: FFT relational shape grammar and anti-rules, `GP-SHAPE-01`, the low-poly construction translation, cultural-mutation MVP/Ideal, lock audit, seed law, and the binding FFT/import boundary. Routes detail to `BATTLEMAP-TOWNTRAY-COMPOSITION` / `TRIM-SHEET-PIPELINE` / `MATERIAL-LANE`. (2026-07-23)
