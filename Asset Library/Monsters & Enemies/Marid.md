...
_Large Elemental (Genie), Chaotic Neutral_

- **Armor Class:** 17
- **Initiative:** +5 (15)
- **Hit Points:** 229 (17d10 + 136)
- **Speed:** 30 ft., Fly 60 ft., Swim 90 ft.
- **STR:** 22 (+6) | **DEX:** 12 (+1) | **CON:** 26 (+8) | **INT:** 18 (+4) | **WIS:** 17 (+3) | **CHA:** 18 (+4)
...
- **Wishes.** The marid has a 30 percent chance of knowing the *Wish* spell. If the marid knows it, the marid can cast it only on behalf of a non-genie creature who communicates a wish in a way the marid can understand. When the marid casts the spell for the creature, the marid suffers one of the spell's stress. Once the marid has cast it three times, the marid can't do so again for 365 days.
...
- **Water Jet.** *Dexterity Saving Throw:* DC 18, each creature in a 60-foot line that is 5 feet wide. *Failure:* 19 (3d6) Cold damage. If the target is a Huge or smaller creature, it is pushed up to 20 feet straight away from the marid and has the Prone condition. *Half damage only on success.*
