...
- TABLE-ATLAS — Reference Shelf app #3 (read-only table-corpus dashboard: wiring + band strips + roll-count telemetry). SPEC-LOCKED 2026-07-06, build DEFERRED (post-Fable). Deps: U0 table-usage split → U1 roll-count seam → U2 atlas app.
