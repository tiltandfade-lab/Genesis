...
| Current Golden engine implementation cut | `GOLDEN-SITE-WAVE-1-OBSERVATORY-BRIEF.md` — deterministic audit harness, read-only adapters, disposition/unresolved ledgers, 12,000-request checkpoint |
...
- `GOLDEN-SITE-VIGNETTE-CONTRACTS.md` — Wave-0-frozen v1 design boundary for
  ...
  contract. Machine companion, work census, selectors, negative controls, and
  baseline live under `intel/`. (2026-07-29)
- `GOLDEN-SITE-WAVE-1-OBSERVATORY-BRIEF.md` — the current implementation cut:
  deterministic audit-only seed namespaces, read-only adapters, six dispositions,
  unresolved-demand vocabulary, 12,000-request natural checkpoint, separate
  stratified corpus, proxy-only asset demand, game/battle sentinels, and Gate W1.
  (2026-07-29)
