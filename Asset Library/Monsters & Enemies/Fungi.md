...
In any campaign, from a whimsical dungeon romp to a harrowing survival-horror hex crawl, subterranean fungi serve as dynamic environmental set pieces. They are the perfect blend of trap, monster, and ecosystem.
...
- **The Violet Fungus Necrohulk:** _Note: The specific monster "Violet Fungus Necrohulk" does not appear in the provided sources._ However, based on the confirmed lore that Violet Fungi rapidly decompose corpses to sprout new growth, and the existence of mindless "Spore Servants" animated by fungal magic, I have synthesized a 2024-compatible "Necrohulk." This represents a massive, animated corpse completely overtaken by an overgrown Violet Fungus acting as its nervous system.
...
- **Tendril:** _Melee Weapon Attack:_ +0 to hit, reach 5 ft. _Hit:_ 3 (1d6) poison damage, and the target has the Poisoned condition until the end of its next turn.
...
### 4. Violet Fungus Necrohulk

*p. 126 MM 2024*

_Large Plant, Neutral Evil_

- **Armor Class:** 17 (natural armor)
- **Hit Points:** 123 (13d10 + 52)
- **Speed:** 40 ft.
- **STR:** 19 (+4) | **DEX:** 12 (+1) | **CON:** 18 (+4) | **INT:** 7 (-2) | **WIS:** 14 (+2) | **CHA:** 10 (+0)
...
- **Rotting Slam:** _Melee Weapon Attack:_ +7 to hit, reach 10 ft., one target. _Hit:_ 9 (1d10 + 4) necrotic damage.
- **Spore Bomb (Recharge 5-6):** *Constitution Saving Throw:* DC 17, each creature in a 20-foot-radius Sphere centered on the necrohulk. *Failure:* 28 (8d6) necrotic damage, and the target has the Poisoned condition until the start of the necrohulk's next turn. While Poisoned, the target can't regain Hit Points. *Success:* Half damage only.

**Bonus Actions**

- **Absorb Body:** *Strength Saving Throw:* DC 15, one Medium or Small creature the necrohulk can see within 5 feet. *Failure:* The target is pulled up to 10 feet into the necrohulk's space and becomes grafted to its body. The necrohulk can have only one target grafted at a time. While grafted, the target has the Restrained condition and Disadvantage on Constitution saving throws. When the necrohulk moves, the grafted target moves with it. The target dies while grafted, it is destroyed, and the necrohulk regains 10 Hit Points. A creature within 5 feet of the necrohulk can take an action to make a DC 15 Strength (Athletics) check. On a success, the target is no longer grafted and moves to an unoccupied space within 5 feet of the necrohulk.

---

### d10 Fungal Encounters & Ecosystems (Tone Variance Table)

Fungi can be utilized as comedic roadblocks or horrifying biological threats. _(Roll or choose one to set the tone of the encounter)._
...
Because Violet Fungi and Gas Spores feed on the dead, the mulch of their lairs is a treasure trove of undigested loot and clues.

| d10    | Discovery in the Mulch       | Investigative Hook                                                                                                                                                                |
| :----- | :--------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1**  | **The Uncorroded Metal**     | Fungi devour organic material but leave metal pristine. A perfectly clean, gleaming silver signet ring of the local magistrate lies in the rot.                                   |
| **2**  | **The Halved Map**           | A leather scroll tube that was partially eaten. The surviving map shows a safe route through the dungeon, but ends abruptly in the middle of a trap-filled corridor.              |
| **3**  | **The Petrified Limb**       | A severed arm that is entirely turned to stone. Violet Fungi couldn't digest it, hinting that a Basilisk or Medusa is hunting in the very near vicinity.                          |
| **4**  | **The Crystalline Vial**     | A dropped, stoppered vial of bright blue liquid. It is a highly potent fungicide that deals 4d10 radiant damage to plant creatures, but only has one use left.                    |
| **5**  | **The Cultist's Mask**       | A wooden mask shaped like a grinning demon. Cultists of the Fungal Queen (the Demon Queen of Fungi) use these patches as holy sites and will return shortly to harvest the deadly spores. |
