...
Secret-Eyes haunt libraries, arcane vaults, and wizard's towers. They are drawn to accumulated knowledge like moths to flame, still chasing the obsession that destroyed them. They are not, strictly speaking, hostile by default — they can be bargained with, particularly if offered something they want to know. But they are deeply unpleasant to deal with, and they have a tendency to share secrets they weren't meant to share.

### Campaign Integration: Investigation & Clues

A secret-eye in an area means arcane history is nearby.

- **The Scratched Equations:** Secret-Eyes compulsively scratch arcane notation into any surface they rest near — fragments of the magical formulas they were researching when they were transformed. A DC 14 Arcana check can identify the school of magic and, potentially, the identity of the original arcanist.
- **The Eye Track:** A secret-eye's enormous central eye leaves a faint luminescent trace on surfaces it has been staring at for extended periods — usually specific spots on walls, doors, or floors, as if it was watching something specific.
- **The Exposed Secret:** NPCs who passed through a secret-eye's territory may report feeling inexplicably paranoid, or that something seemed to know things about them it shouldn't. This is a signature sign.
...
- **Keen Sight:** The secret-eye has Advantage on Wisdom (Perception) checks that rely on sight.

**Actions**

- **Multiattack:** The secret-eye makes two Claw attacks.
- **Claw:** _Melee Weapon Attack:_ +4 to hit, reach 5 ft., one target. _Hit:_ 6 (1d6 + 3) slashing damage.
- **Weird Insight:** The secret-eye targets one creature it can see within 30 ft. The target must contest its Charisma (Deception) check against the secret-eye's Wisdom (Insight) check. If the secret-eye wins, it magically learns one fact or secret about the target. The target knows the secret-eye attempted to read its mind, and it knows whether the secret-eye succeeded.
- **Rotting Gaze:** The secret-eye targets one creature it can see within 30 ft. The target must succeed on a DC 12 Constitution saving throw against this magic or take 10 (3d6) necrotic damage.

---

### d10 Secret-Eye Encounters (Tone Variance Table)

| d10 | Encounter Premise | Campaign Tone / Mechanics |
|:----|:------------------|:--------------------------|
| **1** | **The Toll Keeper** | **Tense Negotiation:** The secret-eye blocks a narrow passage. It won't fight — it wants a secret. Something true and private. It can tell the difference between a lie and the truth. Once it has a secret it finds sufficiently interesting, it steps aside. |
| **2** | **The Librarian** | **Eerie Information Source:** The secret-eye has been living in this archive for decades, reading everything. It knows the contents of every book in the room and will trade that information for — naturally — secrets about the party. |
...
| **10** | **The Truesight Trap** | **Dungeon Design:** The secret-eye is positioned to "see" through illusions the party is relying on — a disguise, a hidden door, an invisible familiar. It calls out what it sees in broken Undercommon. Anyone who understands Undercommon learns the party's deception has been spotted. |
...
| **9** | **The Transformed Chamber** | The room contains evidence of a wizard's study — bookshelves, a desk, an empty spell component cabinet — all thoroughly wrecked over decades of a secret-eye occupying the space. The secret-eye was living in its own former workplace. |
