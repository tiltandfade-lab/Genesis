...
- **Speed:** 30 ft.
- **STR:** 14 (+2) | **DEX:** 22 (+6) | **CON:** 14 (+2) | **INT:** 12 (+1) | **WIS:** 13 (+1) | **CHA:** 19 (+4)
...
- **Scimitar.** Melee Attack Roll: +10, reach 5 ft. Hit: 16 (3d6 + 6) Slashing damage, and the target suffers one of the following effects of the pirate's choice: the target has the Charmed condition until the start of the pirate's next turn; or the target has the Poisoned condition until the start of the pirate's next turn.
