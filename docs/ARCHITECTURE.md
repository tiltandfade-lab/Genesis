...
without WebGL. Since 2026-07-25 theater-boot.js is the composition root over 16 extracted theater
modules (realizers, lighting, practicals, camera, occlusion, sprites, mounts, dressing, mesh,
post, skins, whole-object, figures, overlays, motes, dev workbenches) — map + decision record in
docs/THEATER-MODULES.md.
**Lives in:** `src/ui/theater-boot.js`, `src/ui/theater-tabletop.js`, `src/ui/theater-interior-realize.js`. **Spec:** docs/BATTLE-THEATER.md
