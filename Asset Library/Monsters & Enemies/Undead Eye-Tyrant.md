...
_Large Undead (Eye-Tyrant), Lawful Evil_

- **Armor Class:** 19
- **Initiative:** +12 (22)
- **Hit Points:** 195 (26d10 + 52)
- **Speed:** 0 ft., Fly 40 ft. (hover)
- **STR:** 18 (+4) | **DEX:** 14 (+2) | **CON:** 14 (+2) | **INT:** 19 (+4) | **WIS:** 15 (+2) | **CHA:** 19 (+4)
- **Saving Throws:** CON +7, INT +9, WIS +7, CHA +9
- **Skills:** Perception +12
- **Immunities:** Poison; Charmed, Exhaustion, Paralyzed, Petrified, Poisoned, Prone
- **Senses:** Darkvision 120 ft.; Passive Perception 22
- **Languages:** Deep Speech, Undercommon
- **Challenge:** 14 (11,500 XP, or 13,000 XP in lair) | **Proficiency Bonus:** +5

**Traits**

- **Legendary Resistance (3/Day, or 4/Day in Lair).** If the undead eye-tyrant fails a saving throw, it can choose to succeed instead.

**Actions**

- **Multiattack.** The undead eye-tyrant uses Eye Rays three times.
- **Bite.** Melee Attack Roll: +9, reach 5 ft. Hit: 13 (2d8 + 4) Piercing damage.
- **Eye Rays.** The undead eye-tyrant randomly shoots one of the following magical rays at a target it can see within 120 feet of itself (roll 1d10; reroll if the undead eye-tyrant has already used that ray during this turn):
  ...
  - **6 — Telekinetic Ray.** Strength Saving Throw: DC 17 (the target succeeds automatically if it is Gargantuan). Failure: The undead eye-tyrant moves the target up to 30 feet in any direction. The target has the Restrained condition until the start of the undead eye-tyrant's next turn or until the undead eye-tyrant has the Incapacitated condition. The undead eye-tyrant can also exert fine control on objects with this ray, such as manipulating a tool or opening a door or container.
...
- **Negative Energy Cone.** The undead eye-tyrant's central eye emits an imperceptible, magical wave of negative energy in a 150-foot Cone. Creatures in that area can't regain Hit Points until the start of the undead eye-tyrant's next turn. An intact Humanoid corpse there instantly rises as a Zombie under the undead eye-tyrant's control and takes its turn immediately after the undead eye-tyrant on the same initiative count.

**Legendary Actions**

Legendary Action Uses: 3 (4 in Lair). Immediately after another creature's turn, the undead eye-tyrant can expend a use to take one of the following actions. The undead eye-tyrant regains all expended uses at the start of each of its turns.

- **Chomp.** The undead eye-tyrant makes two Bite attacks.
- **Glare.** The undead eye-tyrant uses Eye Rays.
