// polygon-clipping@0.15.7 — vendored, UMD wrapper replaced with a plain ESM export.
// See README-GENESIS.md in this directory for full provenance. Algorithm body below is
// byte-identical to the npm package's own dist/polygon-clipping.umd.js (lines 6-2493 of
// that file); only the outer UMD (function(global,factory){...}) wrapper and the final
// `return index;` / `}));` lines were replaced with a top-level `export default index;`
// so this file is a real static ES module (importable by both Node and the browser via a
// plain relative import, no bundler/importmap required). This UMD build is polygon-clipping's
// own official published build artifact (dist/polygon-clipping.umd.js inside the npm 0.15.7
// tarball) and already inlines its two runtime dependencies (splaytree, robust-predicates) —
// see README-GENESIS.md and LICENSE-THIRD-PARTY.md for their license texts.
'use strict';
