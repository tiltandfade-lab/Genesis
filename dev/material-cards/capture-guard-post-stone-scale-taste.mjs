...
const outDir = path.join(repoRoot, "artifacts/golden-site-1-stone-scale-taste-v1");
...
try {
  ...
  await page.goto(`http://127.0.0.1:${server.address().port}`
    + "/dev/material-cards/guard-post-stone-scale-taste.html",
  ...
  const image = path.join(outDir, "guard-post-stone-scale-options-labeled.png");
