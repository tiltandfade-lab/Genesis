...
Style block (same for every sheet in this realm): sun-bleached sepia-and-rust palette, dusty film-grain texture, hard midday rim light casting long low-value shadows, weathered leather/canvas/tin textures with visible wear.
...
Style block (repeated here so this section is self-contained): sun-bleached sepia-and-rust palette, dusty film-grain texture, hard midday rim light casting long low-value shadows, weathered leather/canvas/tin textures with visible wear.
