...
Option B's provenance-bearing precision tiers at section 11.71. The live question is **F10.9c**, dividing authority
when several exact placements satisfy the same coarser facts. P10.9 remains mandatory and open. The P10.8 starting
focus policy remains automatic Option A;
