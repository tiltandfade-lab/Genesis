...
| G2.1/G2.2 closure and Wave 2 audit | **G2.1 governing baseline closed:** typed lazy promotion, T0-T3 lifecycle, canonical non-erasure, selective callbacks, pooled provisional NPC casting, transactional creative DM, valence-neutral C0-C4 authority, causal hostile synthesis, least-new-mechanics routing, transactional compilation, P0-P4 learning, tiered private deliberation, and best-case/production-cut separation pass the contradiction/owner audit. **G2.2 mechanical baseline closed:** a small CrisisChain orchestration graph consumes ordinary owner/action receipts; timing, actors, resources, conditions, and persistence stay with canonical owners; concrete branching outcomes replace scalar progress; all presentation remains for promoted Wave 10. **Wave 2 closed explicitly by Adam:** O2.1-O2.11, G2.1-G2.2, P2.12-P2.20, and generated follow-ups are answered/audited and closed in `PROCEDURAL-DUNGEON-DIRECTION.md` sections 10.SWEEP.7-10.SWEEP.8. No build is authorized. |
| Fable readiness | **Safe now only for read-only review of closed Waves 1-2:** Fable may summarize, challenge, cross-reference, find gaps, and help prepare Wave 10, but may not rewrite provenance, treat unresolved renderer choices as settled, or create an authoritative build plan. **First design-to-spec gate:** after promoted Wave 10 closes, Fable may turn the semantic + SceneTray/graphics contract into candidate visual/projection architecture, production slices, and acceptance fixtures, still without execution authority. **Full design-to-build gate:** after all waves and the cross-wave audit close. Codex must explicitly notify Adam at the Wave 10 and final readiness gates. |
| Promoted Wave 10 rapid sweep | **Recommendations surfaced; no ruling presumed.** Proposed release family is one renderer-neutral `SceneTray` contract with typed dungeon/interior, town/social, wilderness/exploration, travel/map, and battle adapters, projected as a lit shallow-oblique schematic/diorama with hybrid storyboard/card support. Combat reconfigures established scene identity and adds only owned precision; range/relationship remains a reliable fallback/accessibility view; exact cells remain tactical/workbench overlay; the current full 3D theater remains a feature-flagged laboratory/future projection. Preserve lighting, normal/material response, sprites, shadows, practicals, atmosphere, and environmental beauty while reducing mounted breadth, geometry complexity, camera freedom, and false exactness. P10.0-P10.12 + G10.1-G10.2 await Adam's batch dispositions in `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.SWEEP; no build is authorized. |
| Promoted Wave 10 batch 1 - PreAlpha BattleMat | **Accepted/amended direction, still open for follow-ups:** one renderer-neutral `SceneTray` remains the authority. The first concrete interim projection is an attractive nearly top-down 3D `PreAlpha BattleMat`: raised/depressed cells encode elevation; blocks/cylinders encode walls, columns, and cover; canonical pixel sprites carry actors; tactical volumes remain honest; ordinary location-bearing nouns without integrated models may use semantic markers whose hover/focus inspector reveals the canonical object sprite/card, state, ownership, evidence, and interactions. A classic side-view `EngagementLens` may show the selected PC on the right and relevant enemies on the left by qualitative relationship/elevation, but it is derived from the board and may never separately resolve movement, reach, cover, line of sight, areas, or exact distance. Taste Card C (board primary + collapsible lens) is Codex's current recommendation; Card D is an optional focus-mode candidate. P10.0/P10.8/P10.10/P10.11 are accepted; G10.1 is accepted with the moving-lift/turtle-communicator example; P10.12, G10.2, and P10.9 are accepted baselines with requested deep dives; P10.1/P10.3-P10.7 and generated F10.1-F10.8 remain open. Detail and taste-card links: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.1. No build is authorized. |
| Promoted Wave 10 full-shell correction | **Isolated scene cards are insufficient; future in-session target is left rail + central scene + persistent right chat.** Prefer Disco Elysium-like continuous readable conversation over a BG1/BG2-style interface orientation. Chat uses a smoked near-black surface at roughly 85% opacity/15% translucency, large comfortable type, internal feed scroll, and pinned composer. A narrow left rail owns Character/Actions/Map/Journal/Menu access. Opening Character produces a compact left dossier rather than a full-screen sheet; it reframes the board and collapses EngagementLens before sacrificing map or chat legibility. The board owns a UI-safe presentation rectangle so no tactical cells hide under transparent UI. Cheap truthful primitives precede markers: an ordinary chest is a stateful textured `FACED_BOX` with body/lid geometry, not a puck. Cards E/F are the recommended shell candidates pending Adam's F10.1a ruling; exact ratios, minimum horizontal-tablet viewport, drawer density, lens default, and object-inspector home remain open. This future direction supersedes the old center-feed/right-panel orientation as a design target but does not authorize changing the current implementation. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.2. |
| Promoted Wave 10 hybrid-renderer correction | **Genesis is not a globally pixel-art renderer.** The Wave 10 target combines a smooth high-resolution 3D substrate—volumetric cells, elevation, blocks, cylinders, cheap stateful geometry, motivated practicals, and real cast shadows—with a crisp canonical pixel-art layer mounted as sprites and surface art. Sprite citizens require physical grounding, alpha-respecting cast shadows, and separate compact contact/drop shadows. Adam confirms normal maps were never implemented: `MATERIAL-IDENTITY.md` remains `SPECCED-WITH-SPIKE`; Cards G-L simulate restrained normal response solely to judge the future target. Historical lower-resolution captures are structural/asset evidence, not the release-resolution target. Cards G-L compare default, expanded-lens, character-drawer, two object-inspection, and large-field states using actual Genesis references where possible. Codex recommends G as baseline, H contextually, I for character reference, K as primary full object inspector with J as a small spatial preview, and L as a same-tray layout/camera state; Adam's F10.1c/F10.1b/F10.3b rulings remain open. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.3. |
| Promoted Wave 10 working visual goal | **Cards G-L are accepted as the working convergence family, not final captures.** Their common law is a clean high-resolution 3D physical substrate, canonical crisp pixel citizens/surface art, practical/cast/contact lighting, integrated left rail + central safe SceneTray + persistent right conversation, compact secondary surfaces, and the ability to spend the same tray on a larger field. Generated nouns, exact ratios, iconography, typography, geometry, interaction behavior, normal-map implementation, and performance remain unaccepted. Genesis is materially close in ingredients: the built dungeon-walk → `SpatialPlan` → semantics/dressing → volumetric-interior path already owns graph topologies, real dimensions/shapes/elevation, doors/interactables, pixel standees, practicals, and shadows. It is not one polish pass away: Waves 1-2's semantic rulings, the new shell/lens/inspection behavior, normal maps, governed primitive bindings, high-resolution proof, and cross-mode convergence remain. F10.1c closes at working-goal level; F10.1b is next. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.4. |
| EngagementLens selection and speakable targeting | **Collapsed until a PC is selected; selecting a PC opens a derived cast/targeting lens with a readable label beneath every shown character.** Labels such as `Goblin 1` and `Goblin 2` are stable scene-local parser handles resolving to canonical entity ids, not newly coined NPC names; movement or lens reclustering may not renumber surviving citizens. Known names may replace generic descriptors only through viewpoint knowledge. The lens remains derived from the authoritative BattleMat and cannot separately decide position or action legality. Exact pre-action population remains F10.1d because melee, move-plus-melee, weapon, and spell ranges differ; Codex recommends showing all perceived relevant citizens with truthful relationship/distance tags, then highlighting/dimming once the intended action is known rather than forcing an action-menu preselection. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.5. |
| Exact-tactics candidate and honest scope | **Selected PC moves to the EngagementLens's left; enemy/target figures compose right and carry stable labels plus direct distance in feet. Both direct selection and natural-language declarations are required and must compile into one validated `ActionIntent`; Fire Bolt is entity/object targeting while Fireball is point/area targeting, so actions need structured target domains rather than one click convention.** On the PC turn, the preferred board interaction shows exact FFT-like reachable cells with XCOM-like normal-move and Dash tiers; second-tier selection may auto-Dash only when the payment source is unambiguous. Current combat is not exact-cell: it compresses exact room dimensions into at most 4×3 band/lane zones, and spell records lack complete target/shape mechanics. Codex recommends promoting exact `SpatialPlan` cells to combat authority, retaining bands/zones as a derived accessibility/text/small-screen fallback and allowing non-combat trays to remain representational. This is a large combat-core program—citizen occupancy, traversal/pathfinding, target/area kernel, law migration, dual input, persistence, and proof—not a renderer overlay; existing exact room geometry, elevation, action budgets, spells, citizens, and renderer reduce but do not erase the scope. Adam's F10.1e decision remains open. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.6. |
| Exact-cell authority, mechanical movement, and reuse research | **Accepted:** exact `SpatialPlan` cells/elevation/occupancy become the intended release combat authority; built zones remain current code until replacement, then a derived accessibility/text/small-screen/degraded fallback. Routine movement and tactical legality resolve locally rather than through per-square DM approval. Both UI and prose compile into one validated intent/receipt; the DM retains open-ended intent, invention, ambiguity, consequences, opposition, and narration. **Dash correction:** normal movement is freely spendable and recomputed incrementally, but extending it requires explicit selection of a legal Action/Bonus Action/resource source first; never auto-spend or silently choose the source. **Research posture:** build a Genesis-owned `TacticalGridKernel` from `SpatialPlan`; a tiny ISC priority queue is the leading direct dependency, EasyStar.js/PathFinding.js/rot.js are bakeoff/reference candidates, Foundry dnd5e is a target/template schema reference, navmesh/agent libraries are deferred, and GPL OpenXcom/Wesnoth are behavioral references only. F10.1e and the payment half of F10.1f are closed; pre-payment Dash preview and consequential-movement warnings remain open. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.7. |
| Locked movement-extension preview | **Accepted:** cells affordable now are fully active; the union of cells reachable through currently legal Dash/movement-extension sources appears as a dim outlined/hatched locked region. Selecting a locked cell filters the explicit source chooser to payments that reach it and previews route cost, payment, and resources remaining; nothing moves or spends before selection and confirmation. The preview recomputes after partial movement and cannot leak hidden hazards. Destination truth includes residual action economy: reaching a chest through Action Dash may leave no Action to open it, while a legal Bonus Action Dash may preserve that affordance. F10.1g and the F10.1f movement-tier/payment branch are closed. Known-consequence warnings and undo remain F10.1h. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.8. |
| Known route-consequence warnings | **Accepted:** safe legal movement commits normally; only a route with a known material consequence receives one concise pre-commit warning. Route presentation marks trigger cells and names rules-visible consequence classes such as opportunity-attack exposure, visible damaging terrain, fall risk, broken concealment, lost aura, or insufficient residual action economy. It offers Continue/Choose Another Route rather than per-cell approval. Viewpoint filtering prevents hidden traps, unseen creatures, undiscovered hazards, or secret reaction choices from leaking. UI, accessibility, controller/touch, natural language, and DM receipts consume the same summary. F10.1h's warning baseline is closed; conditional undo and alternate-route ranking remain generated follow-ups. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.9. |
| Bounded movement undo | **Accepted:** preview remains freely cancelable. The active turn may roll back recent movement segments, including self-owned movement allowance and Dash payment from the same transaction, only until the segment causes or is followed by a roll, reaction, hazard resolution, reveal/new observation, other actor-state change, committed action/interaction, or other external consequence. Undeclared external mutations seal by default; sealed controls explain why. Undo writes a linked rollback receipt, uses a bounded current-turn stack, and never becomes whole-turn rewind. The newer FFT interaction is supporting taste evidence rather than rules authority. F10.1i is closed; alternate-route ranking remains F10.1j. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.10. |
| Resource-bounded safe route ranking | **Accepted:** among paths within the movement budget already authorized, default to no known material consequence, then lower movement cost, then a deterministic canonical tie-break. Retain a least-cost alternative only when its risk/resource profile materially differs. If safety requires a new payment tier, show safe/new-cost and risky/current-cost routes explicitly; choose neither silently. Do not collapse incomparable consequences into an opaque universal score—surface capped typed alternatives. This closes F10.1j and the current exact-movement follow-up branch. Stable speakable-label lifecycle is next at F10.1k. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.11. |
| Monotonic local speakable handles | **Accepted:** generic tactical labels are stable within an encounter/continuous-site `LabelScope`, mapped through viewpoint projection to canonical ids. Never renumber survivors or reuse retired numbers; assign newly revealed citizens/reinforcements monotonically without leaking hidden counts; restore the same handle on same-scope return; retain an old generic alias when a learned proper name replaces display; preserve witnessed transformations explicitly; never leak secret identity; give separately targetable summons/splits new provenance-linked handles. Scope records survive save/replay but generic numbers are not permanent world names. F10.1k is closed; later-story promotion of a rooted unnamed handle remains F10.1l. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.12. |
| Rooted callback labels and completed alias audit | **Accepted:** only rooted continuity-bearing unnamed citizens promote beyond a local label scope, using stable viewpoint-safe observed descriptors; old combat handles remain historical/contextual aliases and learned proper names become primary. Player-coined nicknames may resolve as party-language aliases without overwriting canonical identity. The engine resolves the referent; the DM interprets whether calling Varka `Goblin 2` is a joke, insult, affection, or nothing. Ambiguous aliases ask clarification; secret replacements target the perceived referent without leaking canonical truth. Reinforcement/reveal/return/transformation/summon/split/merge/name/collision/secret-identity cases now share one identity/viewpoint/alias law. F10.1k-F10.1l and the label branch are closed. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.13. |
| Full scrollable board object inspector | **Accepted over Codex's Card J-preview/Card K-full recommendation:** selecting an object opens one complete bounded card inside the central SceneTray/BattleMat, visibly linked to the object. A fixed header/action region keeps identity, obvious state, and primary controls visible; full known description/evidence/ownership/history/secondary controls scroll inside the card. All rows are viewpoint/reveal gated and actions emit ordinary validated intents/receipts. The persistent right rail is exclusively DM chat and narration; resolved object actions may be narrated there, but raw fields, inspector state, and controls may not occupy it. Card K remains rejected evidence. F10.3b home/scroll is closed; board placement, persistence, and simultaneous focus remain. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.14. |
| Ephemeral smart-tooltip object card | **Accepted:** the full scrollable board inspector appears only on object click/activation and one may exist at a time. Any outside click dismisses it while continuing the underlying legal interaction; inside scroll/controls do not dismiss. No pin, drag, multi-card layout, or saved window state. A deterministic placement solver flips/clamps/nudges around the object's projected bounds inside the central SceneTray safe rectangle, never under rails/drawers/lens/insets and never offscreen; responsive size caps plus internal scrolling guarantee fit. It repositions on layout/camera change and closes if the object leaves eligibility. This closes F10.3c placement/persistence/simultaneous-focus branches; action-result persistence remains F10.3d. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.15. |
| Inspector transaction and receipt-driven board feedback | **Accepted with Adam's condition:** an inside-card action keeps the eligible card open through validation and canonical refresh, but the board—not the card alone—must perform the committed receipt. Exact-path PC movement, chest/object state animation, and appropriate sound/caption feedback make the result clear before/as the DM narrates it in the exclusive right rail. Never animate success before commit or wait on AI prose. Refusal stays in place; state change refreshes; pickup/destruction/transfer/lost eligibility closes. Dismissal does not cancel a committed transaction; version ids reject stale repaint; save/load never re-executes an action for animation. Sound is never sole feedback and hidden facts cannot leak. F10.3d and latency/transfer edges are closed; minimum feedback families remain F10.3e. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.16. |
| Tiered receipt-driven feedback families | **Accepted as the best-case target:** presentation resolves through governed specific bindings, then typed movement/state/pickup/impact/projectile/spell/activate/damage/failure/reveal/environment families, then a truthful localized visual/sound/caption fallback, then a tracked presentation gap with accessible text/DM narration rather than silent or false feedback. Bespoke later polish replaces a fallback without changing receipt, mechanics, save state, timing, viewpoint, or accessibility. New actions declare a family or gap. F10.3e is closed; the minimum representative pre-alpha proof remains F10.3f. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.17. |
| Representative feedback proof and interim EngagementLens animation | **Accepted:** the pre-alpha spine proves exact movement/Dash/reaction pauses, chest/door state, pickup transfer, melee, Fire Bolt, Fireball, damage/heal, activate/toggle fallback, reveal, and refusal; every other surfaced receipt gets a truthful fallback or tracked gap. The full family bank remains the target. Interim expressive combat animation may run in the FF6-style bottom EngagementLens when cheaper than 3D-board animation, but it consumes the same canonical receipt and cannot become a second combat authority. F10.3f is closed; F10.3g must divide mandatory board truth from optional lens drama. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.18. |
| Board-truth/EngagementLens-drama split | **Accepted:** the BattleMat always shows exact path/destination/elevation/occupancy, trigger pauses, target/line/point/area/caught citizens, persistent hazards, object/environment/custody state, and minimum localized result feedback. The optional bottom EngagementLens may add richer sprite melee/projectile/spell/reaction/damage/heal performance from the same receipt. A deterministic shared timeline and presentation ids prevent contradiction/duplication; missing/collapsed/disabled lens animation never blocks play or loses information. F10.3g is closed; auto-open/focus behavior remains F10.3h. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.19. |
| Active-character EngagementLens auto-follow | **Provisionally accepted pending mandatory playtest, over Codex's no-focus-theft recommendation:** in combat the lens opens/follows the canonical current turn owner at activation boundaries. Reactions, hazards, and secondary effect sources perform in that tableau without recursively stealing focus. Presentation focus cannot change turn/control/target mechanics; noncombat retains click-selected PC behavior; explicit disabled/minimum-layout/accessibility settings win and board feedback stays complete. Test active-follow versus selected-PC-only across party/enemy density, reactions, fast turns, drawers, and tablet layout; reopen explicitly if focus fighting or comprehension fails. F10.3h is provisionally closed; faction-side orientation remains F10.3i. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.20. |
| Stable EngagementLens faction sides | **Accepted:** party-controlled PCs/companions remain in the left band and hostiles in the right; the active citizen is highlighted wherever it stands rather than mirroring the cast. Party actions perform left-to-right, hostile actions right-to-left, and reactions originate from their stable side without stealing active focus. Directional mirroring/projectiles/lunge/recoil/effects remain reusable presentation-family rules. This preserves the left character-rail anchor while active-follow changes each turn. F10.3i is closed; manual-collapse and neutral/third-party behavior remain. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.21. |
| Encounter-scoped EngagementLens collapse | **Accepted for now:** a deliberate manual collapse suppresses active-follow until the current encounter ends or the player explicitly expands the lens. A new combat restores the default unless a separate durable `Lens Off`/accessibility preference is set. Character-drawer and minimum-layout suppression are transient and may not overwrite either state. F10.3j is closed; playtest must verify the encounter reset is expected. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.22. |
| Top-center initiative portrait ribbon | **Visual direction and deterministic faction-block ordering accepted:** the highest exact average-initiative-priority combat block acts first; citizens within it act from highest priority to lowest. `initiativePriority = canonical initiativeBonus + initiativeEdge`; net Advantage is a nonstacking `+3`, net Disadvantage `-3`, and both cancel. Ordinary initiative uses no d20; exact ties receive one open unmodified tie roll, frozen for the encounter. Portraits retain stable ordered positions and available/active/spent states. This remains chunked rather than BG3-interleaved. F10.3m is closed; reinforcement, override, and overflow details remain open. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` sections 11.22-11.26. |
| Initiative reinforcement insertion | **Accepted for an existing block:** insert a revealed reinforcement at its derived-priority tier; it may act this round only if its block and tier remain ahead of the cursor, otherwise it enters visibly waiting for next round. Never recalculate the block's frozen encounter average/order. Specific summon timing, scheduled `Initiative 0`, or governed entry effects require typed overrides; arrival is not secretly a full activation. Hidden portraits/slots remain forbidden. F10.3n is closed; a genuinely new mid-combat block remains F10.3o. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.27. |
| New initiative blocks entering mid-combat | **Accepted:** when a revealed genuinely independent combat side enters, calculate/freeze its entry-roster average and insert the new block by priority while preserving existing blocks' relative order. It acts this round only if its rightful block slot remains ahead of the cursor; otherwise it waits. Later members do not recalculate its average. Political faction alone does not create a block—present allegiance and independent objectives do; undecided bystanders remain off-ribbon. F10.3o is closed; later allegiance transfer remains F10.3p. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.28. |
| Mid-combat allegiance transfer | **Accepted:** when an allegiance-changing receipt commits, immediately update the same citizen's combat block, targeting/control/aura/reaction relations, and move its portrait to the destination priority tier while carrying `actedRound`/availability. Already-spent actors remain spent; unspent actors act only if the destination block/tier is still ahead. Commit at a receipt boundary, preserve identity/labels/tie state, retire empty blocks, and never recalculate frozen averages. F10.3p is closed; narrative opening authority remains F10.3q. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.29. |
| Typed narrative initiative authority | **Accepted:** established fiction compiles through the least powerful valid opening authority. Readiness/surprise/features normally alter deterministic priority; an already-declared, validated, triggered action/effect may resolve one pre-round receipt; only a named versioned scenario/system rule may force an entire block first/last or to a fixed phase. Freeform narration and late “I act before initiative” declarations do not override calculated order. Every exception has provenance and honest viewpoint-safe explanation. F10.3q is closed; simultaneous/conflicting opening receipts remain F10.3r. Authority: `PROCEDURAL-DUNGEON-DIRECTION.md` section 11.30. |
...
| Wave-0 contract freeze | **Accepted:** Waves 1–2 integrate through the v1 `VignetteRequest`, `VignettePlan`, `SemanticAssetDemand`, and `SynthesisReceipt` fields in `GOLDEN-SITE-VIGNETTE-CONTRACTS.md`. This is a design boundary, not a Golden-number runtime schema; semantic changes require a version and migration. |
