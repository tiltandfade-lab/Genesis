...
**Kin-evils PLACED (2026-07-08):** the kin-supremacist (NPC Want sum 8) and the kin-hater (NPC
Want sum 12) now seed the evil tail of the NPC Want 2d50 — the ideological/world-scale and the
personal/festering versions, both kin-agnostic. Kin-tension now lives at both the situation layer
(NPC Hook 005) and the driver layer (NPC Want 8/12).
