...
const MAGIC_ITEMS_BY_NAME={
 ...
 "armor, +1, +2, or +3": {
  "attunement": false,
  "category": "Armor",
  "description": "Rare (+2), or Legendary (+3) You have a bonus to Armor Class while wearing this armor. The bonus is determined by its rarity.",
  "ench": {
   "bonusOptions": [
    1,
    2,
 ...
 "dragon slayer": {
  "attunement": false,
  "category": "Weapon",
  "description": "You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon. The weapon deals an extra 3d6 damage of the weapon’s type if the target is a Dragon.",
  "kind": "magic",
  "name": "Dragon Slayer",
  "rarity": "Rare",
 ...
 "giant slayer": {
  "attunement": false,
  "category": "Weapon",
  "description": "You gain a +1 bonus to attack rolls and damage rolls made with this magic weapon. When you hit a Giant with this weapon, the Giant takes an extra 2d6 damage of the weapon’s type and must succeed on a DC 15 Strength saving throw or have the Prone condition.",
  "kind": "magic",
  "name": "Giant Slayer",
  "rarity": "Rare",
  "type": "Weapon (Any Simple or Martial)"
 ...
 "horn of blasting": {
  "attunement": false,
  "category": "Wondrous Item",
  "description": "You can take a Magic action to blow the horn, which emits a thunderous blast in a 30-foot Cone that is audible out to 600 feet. Each creature in the Cone makes a DC 15 Constitution saving throw. On a failed save, a creature takes 5d8 Thunder damage and has the Deafened condition for 1 minute. On a successful save, a creature takes half as much damage only. Glass or crystal objects in the Cone that aren’t being worn or carried take 10d8 Thunder damage. Each use of the horn’s magic has a 20 percent chance of causing the horn to explode. The explosion deals 10d6 Force damage to the user and destroys the horn.",
  "kind": "magic",
 ...
 "manual of golems": {
  "attunement": false,
  "category": "Wondrous Item",
  "description": "This tome contains information and incantations necessary to make a particular type of golem. The GM chooses the type or determines it randomly by rolling on the accompanying table. To decipher and use the manual, you must be a spellcaster with at least two level 5 spell slots. A creature that can’t use a Manual of Golems and attempts to read it takes 6d6 Psychic damage. To create a golem, you must spend the time shown on the table, working without interruption with the manual at hand and resting no more than 8 hours per day. You must also pay the specified cost to purchase supplies. Once you finish creating the golem, the book is consumed in eldritch flames. The golem becomes animate when the ashes of the manual are sprinkled on it. See “Monsters” for the golem’s stat block. The golem is under your control, and it understands and obeys your commands. 1d20 Golem Time Cost 1–5 Clay Golem 30 days 65,000 GP 6–17 Flesh Golem 60 days 50,000 GP 18 Iron Golem 120 days 100,000 GP 19–20 Stone Golem 90 days 80,000 GP",
  "kind": "magic",
 ...
 "nine lives stealer": {
  "attunement": true,
  "category": "Weapon",
  "description": "You gain a +2 bonus to attack rolls and damage rolls made with this magic weapon. Life Stealing. The weapon has 1d8 + 1 charges. When you attack a creature that has fewer than 100 Hit Points with this weapon and roll a 20 on the d20 for the attack roll, the creature must succeed on a DC 15 Constitution saving throw or be slain instantly as the sword tears its life force from its body. Constructs and Undead succeed on the save automatically. The weapon loses 1 charge if the creature is slain. When the weapon has no charges remaining, it loses this property.",
  "kind": "magic",
 ...
 "potion of animal friendship": {
  ...
  "description": "When you drink this potion, you can cast the level 3 version of the Animal Friendship spell (save DC 13). Agitating this potion’s muddy liquid brings little bits into view: a fish scale, a hummingbird feather, a cat claw, or a squirrel hair.",
  "kind": "magic",
 ...
 "potion of greater healing": {
  ...
  "description": "You regain Hit Points when you drink this potion (4d4+4).",
  "kind": "magic",
 ...
 "potion of healing": {
  ...
  "description": "You regain Hit Points when you drink this potion (2d4+2).",
  "kind": "magic",
  "name": "Potion of Healing",
  "rarity": "Common",
  "type": "Potion"
 ...
 "potion of mind reading": {
  ...
  "description": "When you drink this potion, you gain the effect of the Detect Thoughts spell (save DC 13) for 10 minutes (no Concentration required). This potion’s dense, purple liquid has an ovoid cloud of pink floating in it.",
  "kind": "magic",
 ...
 "potion of poison": {
  ...
  "consumable": {
   "effect": {
    "kind": "harm",
    "note": "poison — 3d6 poison + Poisoned on a failed CON save (DC 13)"
   }
  },
 ...
 "potion of superior healing": {
  ...
  "description": "You regain Hit Points when you drink this potion (8d4+8).",
  "kind": "magic",
 ...
 "potion of supreme healing": {
  ...
  "description": "You regain Hit Points when you drink this potion (10d4+20).",
  "kind": "magic",
 ...
 "shield, +1, +2, or +3": {
  "attunement": false,
  "category": "Armor",
  "description": "Rare (+3) While holding this Shield, you have a bonus to Armor Class determined by the Shield’s rarity, in addition to the Shield’s normal bonus to AC.",
  "ench": {
   "bonusOptions": [
    1,
    2,
 ...
 "staff of frost": {
  "attunement": true,
  "category": "Staff",
  "description": "You have Resistance to Cold damage while you hold this staff. Spells. The staff has 10 charges. While holding the staff, you can cast one of the spells on the following table from it, using your spell save DC. The table indicates how many charges you must expend to cast the spell. Spell Charge Cost Spell Charge Cost Cone of Cold 5 Ice Storm 4 Fog Cloud 1 Wall of Ice 4 Regaining Charges. The staff regains 1d6 + 4 expended charges daily at dawn. If you expend the last charge, roll 1d20. On a 1, the staff turns to water and is destroyed.",
  "ench": {
   "charges": {
    "max": 10
   }
 ...
 "sword of sharpness": {
  "attunement": true,
  "category": "Weapon",
  "description": "When you attack an object with this magic weapon and hit, maximize your weapon damage dice against the target. When you attack a creature with this weapon and roll a 20 on the d20 for the attack roll, that target takes an extra 14 Slashing damage and gains 1 Exhaustion level.",
  "kind": "magic",
 ...
 "wand of web": {
  "attunement": true,
  "category": "Wand",
  "description": "This wand has 7 charges. While holding it, you can expend 1 charge to cast Web (save DC 13) from it. Regaining Charges. The wand regains 1d6 + 1 expended charges daily at dawn. If you expend the wand’s last charge, roll 1d20. On a 1, the wand crumbles into ashes and is destroyed.",
  "ench": {
   "charges": {
    "max": 7
   }
 ...
 "weapon, +1, +2, or +3": {
  "attunement": false,
  "category": "Weapon",
  "description": "(+2), or Very Rare (+3) You have a bonus to attack rolls and damage rolls made with this magic weapon. The bonus is determined by the weapon’s rarity.",
  "ench": {
   "bonusOptions": [
    1,
    2,
...
const ITEM_CONDITIONS=["on-fire", "poisoned-coated", "cursed", "broken", "dropped", "rusted"];
