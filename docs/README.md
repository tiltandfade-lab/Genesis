...
- `KENNEY-GRAPHICS-REPAIR-OPERATION.md` — SPECCED corrective operation for the Kenney walk-to-graphics pipeline: transform/UV/bounds repair, safe fallback rendering, sidecar calibration, mount-only six-degree-of-freedom sockets plus Kenney-native cell/quarter-turn structural metadata, a manual socket workbench, an explicit ten-asset calibration pass, approval-driven runtime admission, footprint-aware walk-native realization, and a capture/playtest proving gate. (2026-07-16)
