...
/* DURABILITY-TRIO.md §3 (Chronicle ⇐ Ledger): logEvent is now an INERT no-op — the Chronicle renders
   ...
   world.fate/world.rebirth/engine.world-gen need no edits — every one already sits beside an
   equivalent addLedger call carrying the same prose (G0: minimal diffs, no drive-by refactors). */
