...
ROUND 3 — R8 aberrations & monstrosities, all remaining sheets. Everything you need is pasted below — do NOT read repo files for subjects;
...
2. Create a fresh directory named r8b-returns/ under dev/model-qa/faceted-sheets/
   ...
   r8b-returns/raw-figures/<first-cell-id>-candidate-001.png.
...
4. Append one JSON row per call to r8b-returns/provenance/r8b-generation-calls.json:
