> [!info] Dungeon Procedure v3.0 Generator
...
>
> **What gets generated:**
> - **◆ Setup** — Type, Origin, Skin, Art Motif + Modifier, Threat Profile, Rest Pressure, Topology (rolled once)
> - **◆ Rooms** — N segments, each with Space, Lighting, Sensory, Scene, Connections (1–3 exits with door type + state), two Dressing entries + Object + Feature, a full Encounter (Enemy / Hazard / Contact / Problem / Empty), and a Secret with reveal method + payoff tier
> - **◆ Finale** — same structure but with Boss archetype, Finale Type, Revelation, and Exit State in place of an encounter roll
>
...
<%*
// =============================================================================
// DUNGEON SKETCH GENERATOR — Arcana Engine v0.25 · Dungeon Procedure v3.0
// =============================================================================
...
async function generateRoom(roomNum, label) {
...
for (let i = 1; i <= segCount; i++) {
  ...
  roomBlocks.push(await generateRoom(i, label));
}
...
*Generated with Arcana Engine v0.25 — Dungeon Procedure v3.0*
`;
