...
_Large Swarm of Small Fiends (Demon), Chaotic Evil_

- **Armor Class:** 12
- **Initiative:** +0 (10)
- **Hit Points:** 45 (6d10 + 12)
- **Speed:** 40 ft.
- **STR:** 14 (+2) | **DEX:** 11 (+0) | **CON:** 14 (+2) | **INT:** 5 (−3) | **WIS:** 8 (−1) | **CHA:** 3 (−4)
...
- **Fetid Aura.** Constitution Saving Throw: DC 12, any creature that starts its turn in a 10-foot Emanation originating from the swarm. Failure: The target has the Poisoned condition until the end of its next turn. While Poisoned, the target can take either an action or a Bonus Action on its turn, not both, and it can’t take Reactions.
...
- **Rend.** Melee Attack Roll: +4, reach 5 ft. Hit: 12 (3d4 + 2) Slashing damage, or 9 (3d4 + 2) Slashing damage if the swarm is Bloodied.
