> [!info] Urban Procedure v2.5 Generator
...
>
> v2.5: All 16 topologies. Tier selection (T1/T2). Three finale tracks. Topology-aware segment fields. Segment type sub-tables with nested transitions. Full v1.5 table suite.

<%*
// =============================================================================
// URBAN SKETCH GENERATOR — Arcana Engine v0.25 · Urban Procedure v2.5
// v2.5: All 16 topologies. T1/T2. Three finale tracks. Segment type
//       sub-tables with nested transition columns. Full cascade:
...
*Generated with Arcana Engine v0.25 — Urban Procedure v2.5*
`;
