...
**Totals:** 334 tables / 248 files.  
By table — ▶ procedure: **206** · ⛓ chained: **16** · 🔗 wired: **12** · ⚠️ Oracle-only: **100**.  
⚠️ Oracle-only source files: **89** of 248.
...
- [[Monster Behavior if Hunted]] — 1d10, 10 rows
- [[Monster Meal Viability]] — 1d20, 9 rows
- [[Monster Motivation]] — 1d20, 8 rows

### Session Mechanics / Pressure
- [[In-Building Complications]] — 1d20, 5 rows
...
- [[Life & Origins]] — ▶ via Character Genesis Procedure  *(9 sub-tables)*
...
- [[Dungeon Boss]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d100, 100 rows)*
...
- [[Dungeon Dressing Mega Table]] — ▶ via 5-Room Dungeon Generator  *(6 sub-tables)*
- [[Dungeon Empty Result]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d20, 20 rows)*
- [[Dungeon Encounter Type]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d20, 20 rows)*
...
- [[Dungeon Lighting]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d100, 100 rows)*
...
- [[Dungeon Problem]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d50, 50 rows)*
- [[Dungeon Reinforcements]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d6, 6 rows)*
...
- [[Dungeon Set Dressing]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d100, 100 rows)*
- [[Dungeon Set Dressing Condition]] — ▶ via 5-Room Dungeon Generator, Dungeon Encounter  *(d20, 20 rows)*
...
- [[Urban Lighting]] — ▶ via Positive Urban Encounter, Urban Encounter  *(d50, 50 rows)*
...
- [[Urban Set Dressing]] — ▶ via Urban Encounter  *(d100, 100 rows)*
- [[Urban Set Dressing Condition]] — ▶ via Urban Encounter  *(d20, 20 rows)*
...
- [[Wilderness Art]] — ▶ via Wilderness Encounter  *(3 sub-tables)*
...
- [[Wilderness Encounter Type]] — ▶ via Wilderness Encounter  *(d20, 20 rows)*
...
- [[Wilderness Set Dressing]] — ▶ via Wilderness Encounter  *(d300, 300 rows)*
...
- [[Dungeon Secret Type]] — ⚠️ **Oracle-only — no auto trigger**  *(d8, 8 rows)*
...
### Session Mechanics / Monsters
- [[Monster Behavior if Hunted]] — ⚠️ **Oracle-only — no auto trigger**  *(1d10, 10 rows)*
- [[Monster Meal Viability]] — ⚠️ **Oracle-only — no auto trigger**  *(1d20, 9 rows)*
- [[Monster Motivation]] — ⚠️ **Oracle-only — no auto trigger**  *(1d20, 8 rows)*

### Session Mechanics / Pressure
- [[Starting State Pressure]] — ▶ via _START_New World Procedure  *(d100, 24 rows)*
- [[Urban Pressure]] — ▶ via Urban Set Up  *(d100, 100 rows)*
- [[In-Building Complications]] — ⚠️ **Oracle-only — no auto trigger**  *(1d20, 5 rows)*

### Session Mechanics / Travel & Resting
- [[Travel Biome]] — ▶ via Travel Procedure  *(d100, 100 rows)*
...
- [[Travel Destination Type]] — ▶ via Travel Procedure  *(d100, 100 rows)*
...
- [[Region Encounter]] — ⚠️ **Oracle-only — no auto trigger**  *(d20, 20 rows)*
...
- [[NPC Name Megatable]] — ▶ via Quick NPC Generator  *(23 sub-tables)*
...
- [[NPC Demeanor]] — ⛓ chained from NPC Trust Lever.md  *(d100, 100 rows)*
- [[NPC Fear]] — ⛓ chained from NPC Honesty.md, NPC Trust Lever.md  *(d20, 20 rows)*
- [[NPC Honesty]] — ⛓ chained from NPC Trust Lever.md  *(2d10, 8 rows)*
- [[NPC Leverage]] — ⛓ chained from NPC Honesty.md  *(d100, 100 rows)*
- [[NPC Trust Lever]] — ⛓ chained from NPC Honesty.md  *(d20, 20 rows)*
- [[NPC Want]] — ⛓ chained from NPC Trust Lever.md  *(d20, 20 rows)*
...
- [[NPC If Cornered]] — ⚠️ **Oracle-only — no auto trigger**  *(d100, 100 rows)*
...
- [[NPC Immediate Mood]] — ⚠️ **Oracle-only — no auto trigger**  *(d20, 20 rows)*
...
- [[Truth vs False]] — ⛓ chained from Place Mythology.md  *(d6, 6 rows)*
...
- [[Place-Secret]] — ⚠️ **Oracle-only — no auto trigger**  *(d200, 200 rows)*
