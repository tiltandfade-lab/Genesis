# ROUND 2 — cosmic (15 sheets codex missed before the usage limit)

Style reference: dev/model-qa/regen-v3/style-refs/cosmic-style-ref.png
...
## Sheet 10: `cosmic-large-v3-10.png` — 4 sprites, 2 rows x 2 columns
...
1. draped spider-limbed horror
2. tentacled maw altar
3. antlered star deer grazing
4. fish-demon brute
```

## Sheet 11: `cosmic-large-v3-11.png` — 4 sprites, 2 rows x 2 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. horned beast on throne steps
2. kite-headed spider walker
3. fused twin skeletal horror
4. sludge horror shaping a figure
```

## Sheet 12: `cosmic-large-v3-12.png` — 4 sprites, 2 rows x 2 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. armored reptilian beast
2. star griffin-bird
3. water elemental figure
4. enthroned queen with kneeling worshippers
```

## Sheet 13: `cosmic-large-v3-13.png` — 4 sprites, 2 rows x 2 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. two-headed panther beast
2. cathedral-backed skeleton
3. many-mouthed hulk
4. hunched one-eyed shadow beast
```

## Sheet 14: `cosmic-large-v3-14.png` — 4 sprites, 2 rows x 2 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. door-torso armored golem with axe
2. winged dragon-man with standard
3. wheel of bodies with central eye
4. boiling mass of faces
```

## Sheet 15: `cosmic-large-v3-15.png` — 4 sprites, 2 rows x 2 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. fish-troll crouched with spear
2. fish-troll with chain flail
3. skeletal winged demon
4. shrouded tentacle pillar figure
```

## Sheet 16: `cosmic-large-v3-16.png` — 4 sprites, 2 rows x 2 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. shadow horror dangling small figure
2. multi-headed screaming mass
3. winged cthulhu brute
4. bear
```

## Sheet 17: `cosmic-large-v3-17.png` — 4 sprites, 2 rows x 2 columns
...
2. black bear
3. elk/moose
4. constellation oryx
```

## Sheet 18: `cosmic-large-v3-18.png` — 4 sprites, 2 rows x 2 columns
...
## Sheet 19: `cosmic-medium-beast-v3-19.png` — 5 sprites, 2 rows x 4 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. caparisoned saluki dog
2. goat with vessel and drape
3. bridled monitor lizard
4. draped water buffalo calf
5. chained baboon
```

## Sheet 20: `cosmic-small-v3-20.png` — 14 sprites, 3 rows x 5 columns
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. star-marked mongoose
2. starry hen with chicks
3. rabbit in gilded birdcage
4. collared ocelot kitten
5. gilded egret
6. civet with censer
7. fennec fox
8. cobra reared from bowl
9. collared serval cat
10. draped grey kitten
11. pale sigil kitten
12. red fox
13. fox kit
14. ibis group
```

## Sheet 21: `cosmic-solo-v3-21.png` — 1 sprites, 1 row x 1 column
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. city-backed crab crawler
```

## Sheet 22: `cosmic-solo-v3-22.png` — 1 sprites, 1 row x 1 column
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. cathedral rising from wave
```

## Sheet 23: `cosmic-solo-v3-23.png` — 1 sprites, 1 row x 1 column
...
Palette: disciplined navy-and-gold with rich accent color where the subject earns it.
Subjects, one per cell, left to right then top to bottom:
1. pentagonal maw over drowned city
```

## Sheet 24: `cosmic-tiny-v3-24.png` — 13 sprites, 2 rows x 7 columns
...
1. jeweled hedgehog
2. moon-marked dove
3. toad with snail on back
4. quail in gilded cage
5. trio of ornate moths
6. ducklings with lamp
7. canary
8. pigeon with message tube
9. silverfish group
10. big-eyed pale mole creature
11. sigil roaches group
12. scarab beetle group
13. bee-eater birds flying
```

# EXPANSION — Tarot Arcana (Adam 2026-07-10: more major/minor arcana characters in cosmic)
