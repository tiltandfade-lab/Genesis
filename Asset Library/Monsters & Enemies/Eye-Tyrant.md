...
- **Challenge:** 13 (10,000 XP, or 11,500 XP in lair) | **Proficiency Bonus:** +5

**Traits**

- **Legendary Resistance (3/Day, or 4/Day in Lair).** If the eye-tyrant fails a saving throw, it can choose to succeed instead.

**Actions**

- **Multiattack.** The eye-tyrant uses Eye Rays three times.
- **Bite.** _Melee Attack Roll:_ +8, reach 5 ft. _Hit:_ 13 (3d6 + 3) Piercing damage.
- **Eye Rays.** The eye-tyrant randomly shoots one of the following magical rays at a target it can see within 120 feet of itself (roll 1d10; reroll if the eye-tyrant has already used that ray during this turn):
  ...
  5. **Enervation Ray.** *Constitution Saving Throw:* DC 16. *Failure:* 13 (3d8) Poison damage, and the target has the Poisoned condition until the end of its next turn. *Success:* Half damage only.
  6. **Telekinetic Ray.** *Strength Saving Throw:* DC 16 (the target succeeds automatically if it is Gargantuan). *Failure:* The eye-tyrant moves the target up to 30 feet in any direction. The target has the Restrained condition until the start of the eye-tyrant's next turn or until the eye-tyrant has the Incapacitated condition. The eye-tyrant can also exert fine control on objects with this ray, such as manipulating a tool or opening a door or container.
...
- **Antimagic Cone.** The eye-tyrant's central eye emits an antimagic wave in a 150-foot Cone. Until the start of the eye-tyrant's next turn, that area acts as an Antimagic Field spell, and that area works against the eye-tyrant's own Eye Rays.

**Legendary Actions**

_Legendary Action Uses: 3 (4 in Lair). Immediately after another creature's turn, the eye-tyrant can expend a use to take one of the following actions. The eye-tyrant regains all expended uses at the start of each of its turns._

- **Chomp.** The eye-tyrant makes two Bite attacks.
- **Glare.** The eye-tyrant uses Eye Rays.
