...
| complete | `M035-A` ridge tent | thin cloth over a timber frame | Can broad cloth, an open threshold, and separable supports survive low remesh? **Passed at 712 cleaned triangles after mirrored rear flaps were replaced with a deterministic back panel.** |
