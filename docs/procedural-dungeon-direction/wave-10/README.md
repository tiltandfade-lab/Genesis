...
Wave 10 is **OPEN**. It was promoted ahead of Waves 3-9. The current live position is **F10.8d.1**:
choose the clean fiction-first fallback when Gemini is late, unavailable, interrupted, or invalid.
...
|---|---|---|
| [01](01-shell-movement-and-labels.md) | 11-11.13 | Promoted-wave setup, shell, SceneTray, movement, and speakable labels |
...
| **[05 — current](05-consequence-presentation.md)** | **11.57-11.61** | Cue scheduling, interruption recovery, consequence presentation, and Gemini-led rewrite |
...
index and the stable root map in the same change.
