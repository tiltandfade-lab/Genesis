...
| Bounded town continuity | A compact canonical district graph owns stable venue nodes, thresholds, short edges, access, and shared cast/object/condition truth; real-roll reusable urban grids mount only active venues; short Urban Walk/direct thresholds preserve time and due updates; exact travel-threshold arrival leads through one market interaction to same-venue BattleMat/aftermath, bounded offscreen update, semantic compaction, and leave/return; material citizens promote while ambient population may remain pooled; companion action/attention hooks stay dormant until C4D | C2M after connected core | C2M plus final F10.9h boundary audit | Scoped contiguous town slices, richer ambient citizens, enabled C4D companion roaming, cross-venue events, and broader venue grammars; no entitlement to simulate every street/building/resident or generate bespoke venue imagery | The retained district feels like disconnected menus, cannot remount meaningful changes, or cannot host accepted same-scene social/companion consequences | MAPPED IN PART; F10.9h.1-h.10 accepted through 11.87, final h.11-h.15 audit live at 11.88 |
...
- P10.9 F10.9a accepted the transactional SceneLineage handoff and added C2D as the first retained continuity proof;
  ...
  F10.9g is closed at section 11.83. F10.9h accepts bounded canonical town fabric before scoped contiguous-town
  enrichment; h.1-h.10 now bind the district graph, real-roll venue grids, same-venue battle/aftermath, bounded
  offscreen receipts, short Urban Walk, exact arrival, promoted citizens, semantic remount, dormant autonomy hooks,
  and one integrated leave/return fixture to C2M. The final h.11-h.15 boundary audit is live. Generated P10.9
  follow-ups still own the town, CrisisChain, and broader recovery/
  visual-memory obligations before its MVP gate can be complete.
