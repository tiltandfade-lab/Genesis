...
- "Read AGENTS.md first, then read <spec path> — that is your spec, execute it EXACTLY as
...
together via `/genesis-clean-close`. Commits end with the Co-Authored-By line per AGENTS.md.
